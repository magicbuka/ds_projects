...
Для более комфортного знакомства с проектами предлагаю воспользоваться [интерактивным интерпретатором](https://nbviewer.org/github/magicbuka/ds_projects/tree/main/)
